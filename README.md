...
![alt text](Feature_Showcase/01_Single_Image_Reverse_Prompt.png)
![alt text](Feature_Showcase/02_Multi_Image_Comparison.png)
![alt text](Feature_Showcase/03_Video_Reverse_Prompt.png)
- **🤖 Intelligent Dialogue [With Image Analysis]**
![alt text](Feature_Showcase/Smart_Chat.png)
- **🤖 Batch Folder Tagging**
![alt text](Feature_Showcase/Batch_Tagging.png)
- **🤖 Folder Comparison Tagging [Suitable for kontext/Qwen-edit]**
![alt text](Feature_Showcase/Folder_Comparison_Tagging.png)
...
pip install -r requirements.txt
```
![alt text](Feature_Showcase/Auto_Download_Models.png)
...
**Example Paths:**
- Qwen3-VL-4B-Instruct: `ComfyUI/models/llm/Qwen-VL/Qwen3-VL-4B-Instruct/`
- Qwen3-VL-8B-Instruct: `ComfyUI/models/llm/Qwen-VL/Qwen3-VL-8B-Instruct/`
...
**Detailed Guide:** See (Batch_Tagging_User_Guide.md)
